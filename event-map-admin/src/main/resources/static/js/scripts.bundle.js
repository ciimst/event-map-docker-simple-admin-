...
$(document).ready(function () {
			...
			var n = {
				offset: 110, stateId: "m-meta", init: function (t) {
					...
					e(a.tableHead).find(".m-datatable__cell").mousedown(function (a) {
						...
						if (o) {
							var r = e(i).index(), s = e(a.tableBody),
					...
					var i = t.columns, l = e(o).find(".m-datatable__row"),
			...
			var o = {
				redraw: function () {
					...
					a.API.params = e.extend({}, {
						...
						}, sort: {sort: l.sort, field: l.field}, query: {}
					...
					return a.API.params = e.extend({}, {
						pagination: {
							page: 1,
							perpage: o.getOption("data.pageSize")
						}, sort: {sort: i.sort, field: i.field}, query: {}
	...
	e.fn.mDropdown = function (t) {
		var a = {}, n = e(this), o = {
			run: function (e) {
				...
				var e = n.outerWidth(),
					t = a.arrow.hasClass("m-dropdown__arrow--right") ? "right" : "left", o = 0;
				...
				var t = a.wrapper, n = t.offset(), o = t.outerHeight(),
		...
		e(".m-dropdown.m-dropdown--open").each(function () {
			if (e(this).data("dropdown")) {
				var a = e(t.target), n = e(this).mDropdown(),
			...
			run: function (e, t) {
				...
				if ("dropdown" === o.getSubmenuMode()) {
					var i, l = n.find("> .m-menu__nav > .m-menu__item--resize"),
						r = l.find("> .m-menu__submenu"), s = mUtil.getViewPort().width;
	...
	if (c.horizontal ? (t = c.base, a = c.x, n = c.y - c.height / 2, o = c.y + c.height / 2, i = a > t ? 1 : -1, l = 1, r = c.borderSkipped || "left") : (t = c.x - c.width / 2, a = c.x + c.width / 2, n = c.y > 2 * m ? c.y - m : c.y, i = 1, l = (o = c.base) > n ? 1 : -1, r = c.borderSkipped || "bottom"), u) {
		var p = Math.min(Math.abs(t - a), Math.abs(n - o)), f = (u = u > p ? p : u) / 2,
			g = t + ("left" !== r ? f * i : 0), h = a + ("right" !== r ? -f * i : 0),
			b = n + ("top" !== r ? f * l : 0), v = o + ("bottom" !== r ? -f * l : 0);
