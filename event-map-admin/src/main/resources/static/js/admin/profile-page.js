...
$profileEditModal.on('show.bs.modal', function (event) {
	...
	if (type === "add") {
		...
		modal.find('input#isDefault').prop("checked", data.isDefault);
	}
...
function noDefaultProfileAlert(){
	
	custombox.alert(lang.get("label.please.choose.default.profile"), function () {});
}

$( document ).ready(function() {
	
	var defaultProfileId = $("#defaultProfileId").val();
