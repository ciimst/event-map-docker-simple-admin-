...
import com.imst.event.map.admin.db.multitenant.provider.DataSourceBasedMultiTenantConnectionProviderMssqlImpl;


@ConditionalOnBean(DataSourceBasedMultiTenantConnectionProviderMssqlImpl.class)
@Configuration
@EnableTransactionManagement
@ComponentScan(basePackages = { "com.imst.event.map.admin.db.repositories.mssql", "com.imst.event.map.hibernate.entity" })
@EnableJpaRepositories(basePackages = { "com.imst.event.map.admin.db.repositories.mssql" },
...
public class MssqlTenantDatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		emfBean.setPackagesToScan( "com.imst.event.map.admin.db.repositories.mssql", "com.imst.event.map.hibernate.entity" );
