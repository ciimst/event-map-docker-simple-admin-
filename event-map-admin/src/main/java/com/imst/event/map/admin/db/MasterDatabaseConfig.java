package com.imst.event.map.admin.db;
...
@EnableJpaRepositories(basePackages = { "com.imst.event.map.hibernate.entity", "com.imst.event.map.admin.db.repositories" },
...
public class MasterDatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean masterEntityManagerFactory(@Qualifier("masterDataSource") DataSource masterDataSource) {
		...
		em.setPackagesToScan("com.imst.event.map.hibernate.entity", "com.imst.event.map.admin.db.repositories");
