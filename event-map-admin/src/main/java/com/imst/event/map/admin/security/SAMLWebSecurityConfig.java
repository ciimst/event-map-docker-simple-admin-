...
//import com.imst.event.map.admin.constants.Config;
//import com.imst.event.map.admin.security.saml.MySamlUserDetailService;
//import com.imst.event.map.admin.utils.DatabasePasswordEncryptUtils;
//import com.imst.event.map.admin.utils.PropertiesUtil;
//
...
//		String samlContextPath= prop.getProperty("server.servlet.context-path");
...
//                .withSpContextPath(samlContextPath)
...
//                .withSuccessLogoutUrl("/home/logout") // samlda logout olduğumuzda yönlenecek sayfa
