package com.imst.event.map.admin.db.dao;
...
import com.imst.event.map.admin.db.support.CustomSpecification;
...
public class MasterDao{
	...
	public <D, T> TypedQuery<Long> getCountQuery(CustomSpecification<D, T> spec) {
		...
		Predicate predicate = spec.toPredicateCount(root, criteriaBuilder);
		if (predicate != null) {
			query.where(predicate);
		}
