...
//import com.imst.event.map.admin.db.multitenant.provider.DataSourceBasedMultiTenantConnectionProviderOracleImpl;
//
//
//@ConditionalOnBean(DataSourceBasedMultiTenantConnectionProviderOracleImpl.class)
//@Configuration
//@EnableTransactionManagement
//@ComponentScan(basePackages = { "com.imst.event.map.admin.db.repositories.oracle", "com.imst.event.map.hibernate.entity" })
//@EnableJpaRepositories(basePackages = { "com.imst.event.map.admin.db.repositories.oracle" },
...
//
//		emfBean.setPackagesToScan( "com.imst.event.map.admin.db.repositories.oracle", "com.imst.event.map.hibernate.entity" );
