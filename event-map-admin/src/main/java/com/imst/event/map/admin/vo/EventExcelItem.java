...
public class EventExcelItem {
	...
	public EventExcelItem() {
	
	}
	
	//bunu silme
	public EventExcelItem(Integer id, String title, String spot, String description, 
	...
	public EventExcelItem(Event event) {
	...
	public static EventExcelItem newInstanceForLog(Event event) {
		
		return new EventExcelItem(event);
	}
}
