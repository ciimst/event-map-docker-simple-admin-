package com.imst.event.map.admin.db.multitenant;
...
import com.imst.event.map.admin.db.multitenant.conf.TenantIdentifierResolver;
import com.imst.event.map.admin.db.multitenant.provider.DataSourceBasedMultiTenantConnectionProviderGenericImpl;

@ConditionalOnBean(DataSourceBasedMultiTenantConnectionProviderGenericImpl.class)
@Configuration
@EnableAutoConfiguration
@EnableTransactionManagement
@ComponentScan(basePackages = { "com.imst.event.map.hibernate.entity",	"com.imst.event.map.admin.db.repositories.generic" })
@EnableJpaRepositories(basePackages = { "com.imst.event.map.admin.db.repositories.generic" },
...
public class TenantDatabaseConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		emfBean.setPackagesToScan( "com.imst.event.map.admin.db.repositories.generic", "com.imst.event.map.hibernate.entity" );
